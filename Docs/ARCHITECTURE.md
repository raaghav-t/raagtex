...
- macOS local compile target is intentionally unsandboxed while it launches the user's installed TeX binaries; sandboxed distribution needs a managed toolchain or helper design
